pipeline {
    ...
    stages{
        ...
        stage ('deploy to staging'){
            steps{
                sh 'scp -i  /var/lib/jenkins/aws-shahin.pem /var/lib/jenkins/workspace/package/webapp/target/webapp.war ec2-user@34.243.81.194:/opt/tomcat/tomcat8/webapps'
            }
            post{
                success{
        ...
        stage ('deploy to production'){
            steps{
                ...
                sh 'scp -i  /var/lib/jenkins/aws-shahin.pem /var/lib/jenkins/workspace/package/webapp/target/webapp.war ec2-user@34.240.38.127:/opt/tomcat/tomcat8/webapps'
            }
            post{
                success{
